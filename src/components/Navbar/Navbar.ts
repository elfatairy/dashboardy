...
export class Navbar {
  ...
  render(container: HTMLElement): void {
      ...
      <div class="${styles.contents}">
        ...
        <div class="${styles.collapseMenu}" data-open="${true}">
          <button class="${styles.collapseMenuHeader}">
            <svg class="${styles.collapseMenuToggleIcon}" width=".625rem" height=".625rem" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52" enable-background="new 0 0 52 52" xml:space="preserve"><g stroke-width="0"></g><g stroke-linecap="round" stroke-linejoin="round"></g><g> <path d="M8.3,14h35.4c1,0,1.7,1.3,0.9,2.2L27.3,37.4c-0.6,0.8-1.9,0.8-2.5,0L7.3,16.2C6.6,15.3,7.2,14,8.3,14z"></path> </g></svg>
    ...
    navbarPlaceholder.addEventListener('click', () => {
      this.navbarContainer?.setAttribute('data-open', 'false');
    });
    ...
    container.appendChild(this.navbarContainer);
  ...
  showNavbar(): void {
    if (this.navbarContainer) {
      this.navbarContainer.setAttribute('data-open', 'true');
    }
  }
