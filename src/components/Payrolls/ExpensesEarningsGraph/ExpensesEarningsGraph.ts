    ...
    block.innerHTML = `
      <div class="${styles.blockHeader}">
        <div class="${styles.blockHeaderLeft}">
          ...
          <h3 class="${styles.blockHeaderLeftTitle}">Payroll Expenses / Earnings</h3>
        </div>
  ...
  private renderContent(): void {
    ...
    this.leftContent.innerHTML = `
      <div class="${styles.blockContentLeftContent}">
        <span class="${styles.totalExpenses}" data-testid="expenses-earnings-graph-value">${currentPercentage.toFixed(2)}%</span>
