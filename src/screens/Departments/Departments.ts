...
export class DepartmentsScreen {
  ...
  render(container: HTMLElement): void {
    ...
    departments.className = styles.departments;
    departments.innerHTML = `
      <div id="${this.hash}-departments-table-container"></div>
    `;

    this.departmentsTable.render(departments.querySelector(`#${this.hash}-departments-table-container`) as HTMLElement, this.tableProps);
