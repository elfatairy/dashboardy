...
export class ProjectsScreen {
  ...
  render(container: HTMLElement): void {
    ...
    this.projectsTable.render(projectsContainer.querySelector(`#${this.hash}-projects-table-container`) as HTMLElement, tableProps);
    this.projectsStats.render(projectsContainer.querySelector(`#${this.hash}-projects-stats-container`) as HTMLElement);
