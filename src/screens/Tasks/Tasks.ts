...
export class TasksScreen {
  ...
  private tasksTable: Table<Task> = new Table<Task>();
  ...
  render(container: HTMLElement): void {
    ...
    tasksContainer.className = styles.tasks;
    tasksContainer.innerHTML = `
      <div id="${this.hash}-tasks-table-container"></div>
    `;

    this.tasksTable.render(tasksContainer.querySelector(`#${this.hash}-tasks-table-container`) as HTMLElement, tableProps);
